...
<head>
    ...
    <meta property="og:description" content="Hola <?php echo utf8_encode($nombre)?>! Esta es tu mesa asignada para el Bar Mitzvah de Matu" />
...
<div class="jumbotron text-center" style="background-color: rgba(255,255,255, 0.5)">
    <div class="container">
        <h2 style="color: white"><strong>TU MESA ASIGNADA ES LA #: <?php echo $mesa?></strong> </h2>
